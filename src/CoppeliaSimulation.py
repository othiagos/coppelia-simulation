...
def set_quadcopter_pos_ori(
    ...
    last_pos = np.array(sim.getObjectPosition(quad_target_handle, sim.handle_world))
    last_ori = np.array(sim.getObjectOrientation(quad_target_handle, sim.handle_world))
